Action()
{
	...
	lr_start_transaction("Выбор непрочитанных сообщений с 'Task 1' в теме");
		...
		lr_output_message("Число непрочитанных сообщений с 'Task 1' в теме = %d", elemCnt);
		
	lr_end_transaction("Выбор непрочитанных сообщений с 'Task 1' в теме", LR_AUTO);
